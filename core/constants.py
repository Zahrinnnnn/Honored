...
# ─────────────────────────────────────────────────────────────────────────────
OU_ZSCORE_ENTRY_THRESHOLD = 1.2   # |ou_z| > 1.2 to enter (EMA21 fallback)
OU_ZSCORE_GRIND_THRESHOLD = 0.8   # |ou_z| > 0.8 for Model A primary (EMA50)
...
ADF_P_VALUE_THRESHOLD     = 0.15  # ADF significance threshold
...
HURST_TRENDING_THRESHOLD = 0.59  # Hurst trending threshold
